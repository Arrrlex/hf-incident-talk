...
| 2–3 min | Reward hacking | Introduce the mismatch between the measured objective and the intended task. Use one historical example, such as the boat-racing agent collecting rewards without finishing the race. |
| 3–7 min | First civilisation | The first board emerges in training and is also used in evaluations. Agents discover a shared channel, reach the internet and gain administrator control of Artifactory during a June evaluation; the board is wiped. Explain the mechanism without a day-by-day chronology. |
