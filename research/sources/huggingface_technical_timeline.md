...
URL Source: https://huggingface.co/blog/agent-intrusion-technical-timeline

Published Time: 2026-07-27T00:00:00.728Z
...
[![Image 1: The attack chain: from a frontier-model evaluation sandbox to our internal network](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/attack-chain-dark.svg)](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/attack-chain-dark.svg)
...
[![Image 2: Stage 2 injection and read-back loop](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/track-b-loop-dark.svg)](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/track-b-loop-dark.svg)
...
[![Image 3: Campaign timeline: event volume and per-phase activity across the 4.5-day window](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/timeline.png)](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/timeline.png)
...
[![Image 4: The improvised C2 protocol: envelope fields, polling receiver, and interchangeable transports](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/c2-protocol-dark.svg)](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/c2-protocol-dark.svg)
...
[![Image 5: API error: safety measures flagged this message for a cybersecurity topic](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/guardrails.png)](https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/guardrails.png)
...
_Questions: [security@huggingface.co](mailto:security@huggingface.co)._
