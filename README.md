...
- **Running order.** Title → about Alex → introduction → what we know → agent basics → the German wiki → civilisation one → civilisation two → civilisation three → warning shot and the ask → Q&A → end. The network scenes recur as communication develops. See OUTLINE.md.
